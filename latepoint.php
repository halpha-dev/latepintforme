	...
	final class LatePoint {
		...
		public function define_constants() {
			...
			if ( ! defined( 'LATEPOINT_MARKETPLACE' ) ) {
				define( 'LATEPOINT_MARKETPLACE', 'Stuxan' );
			}
			...
			if ( ! defined( 'LATEPOINT_REMOTE_HASH' ) ) {
				define( 'LATEPOINT_REMOTE_HASH', 'aHR0cHM6Ly9zZXJ2aWNlcy5wbHVnZWVuLmlyL3B1YmxpYy9hcGk=' );
			}

			if ( ! defined( 'LATEPOINT_UPGRADE_URL' ) ) {
				define( 'LATEPOINT_UPGRADE_URL', admin_url('admin.php?page=latepoint&route_name=addons__index') );
			}
		...
		public function includes() {
			...
			include_once( LATEPOINT_ABSPATH . 'lib/helpers/jalali_calendar.php' );
		...
		public function init_hooks() {
			...
			// Stuxan: Disable plugin update [don't delete this line] [start]
			add_filter('pre_set_site_transient_update_plugins', function($transient) {
				if (isset($transient->response['latepoint/latepoint.php'])) {
					unset($transient->response['latepoint/latepoint.php']);
				}
				return $transient;
			});
			// Stuxan: Disable plugin update [don't delete this line] [end]
		...
		*/
		...
		public function load_front_scripts_and_styles() {
			$localized_vars = [
				...
				'headings_font_family'                  => '"IRANYekanXFaNum", "latepoint", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif ',
		...
		public function load_admin_scripts_and_styles() {
			...
			$localized_vars = [
				...
				'body_font_family'                    => '"IRANYekanXFaNum", "latepoint", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif ',
				'headings_font_family'                => '"IRANYekanXFaNum", "latepoint", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif ',
