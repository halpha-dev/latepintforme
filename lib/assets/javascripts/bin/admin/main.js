...
function latepoint_init_custom_day_schedule(){
  ...
  jQuery('.custom-day-calendar').on('click', '.os-day', function(){
    ...
    if(jQuery('.custom-day-calendar').data('picking') == 'start'){
      jQuery('.custom-day-settings-w #start_custom_date').val($this.data('jdate')).trigger('keyup');
      ...
      jQuery('.custom-day-settings-w #end_custom_date').val($this.data('jdate')).trigger('keyup');
    }
