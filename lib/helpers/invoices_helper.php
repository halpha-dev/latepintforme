	...
	public static function add_activity_view_vars_for_invoice( array $vars, OsActivityModel $activity ): array {
		...
		switch ( $activity->code ) {
			case 'invoice_created':
				...
				$vars['meta_html']     = '<div class="activity-preview-to"><span class="os-value">' . $link_to_invoice . '</span><span class="os-label">' . __( 'Created On:', 'latepoint' ) . '</span><span class="os-value">' . $activity->get_nice_jcreated_at() . '</div>';
			...
			case 'invoice_updated':
				...
				$vars['meta_html']     = '<div class="activity-preview-to"><span class="os-value">' . $link_to_invoice . '</span><span class="os-label">' . __( 'Updated On:', 'latepoint' ) . '</span><span class="os-value">' . $activity->get_nice_jcreated_at() . '</div>';
