...
class OsStepsHelper {
	...
	public static function get_step_label_by_code( string $step_code, string $parent_prefix = '' ): string {
		$labels = [
			'booking'             => __('Booking Process', 'latepoint'),
			'booking__services'   => __('Services', 'latepoint'),
			'booking__locations'  => __('Locations', 'latepoint'),
			'booking__agents'     => __('Agents', 'latepoint'),
			'booking__datepicker' => __('Datepicker', 'latepoint'),
			'customer'            => __('Customer', 'latepoint'),
			'verify'              => __('Verify Order', 'latepoint'),
			'payment__times'      => __('Payment Time', 'latepoint'),
			'payment__portions'   => __('Payment Portion', 'latepoint'),
			'payment__methods'    => __('Payment Method', 'latepoint'),
			'payment__processors' => __('Payment Processors', 'latepoint'),
			'payment__pay'        => __('Payment Form', 'latepoint'),
