...
class OsUtilHelper {
  ...
  public static function add_resource_link_html(string $label, string $url) : string{
   ...
   public static function get_jmonth_name_by_number($month_number, $short = false){
    $month_names = [__('فروردین', 'latepoint'),
                    __('اردیبهشت', 'latepoint'),
                    __('خرداد', 'latepoint'),
                    __('تیر', 'latepoint'),
                    __('مرداد', 'latepoint'),
                    __('شهریور', 'latepoint'),
    ...
    //if($short) $month_name = mb_substr($month_name, 0, 3);
    return $month_name;
  }
  ...
  public static function translated_jmonths(){
    return [ 'January' => __('فروردین', 'latepoint'),
                'February' => __('اردیبهشت', 'latepoint'),
                'March' => __('خرداد', 'latepoint'),
                'April' => __('تیر', 'latepoint'),
                'May' => __('مرداد', 'latepoint'),
                'June' => __('شهریور', 'latepoint'),
                'July' => __('مهر', 'latepoint'),
                'August' => __('آبان', 'latepoint'),
                'September' => __('آذر', 'latepoint'),
                'October' => __('دی', 'latepoint'),
                'November' => __('بهمن', 'latepoint'),
                'December' => __('اسفند', 'latepoint'),
                'Jan' => __('فروردین', 'latepoint'),
                'Feb' => __('اردیبهشت', 'latepoint'),
                'Mar' => __('خرداد', 'latepoint'),
                'Apr' => __('تیر', 'latepoint'),
                'May' => __('مرداد', 'latepoint'),
                'Jun' => __('شهریور', 'latepoint'),
                'Jul' => __('مهر', 'latepoint'),
                'Aug' => __('آبان', 'latepoint'),
                'Sep' => __('آذر', 'latepoint'),
                'Oct' => __('دی', 'latepoint'),
                'Nov' => __('بهمن', 'latepoint'),
                'Dec' => __('اسفند', 'latepoint')];
  }
  public static function translate_jmonths($date_string){
    $date_string = str_replace(array_keys(self::translated_jmonths()), array_values(self::translated_jmonths()), $date_string);
    return $date_string;
  }
  ...
  public static function get_jmonths_for_select(){
    $months = [];
    for($i = 1; $i<= 12; $i++){
      $months[] = ['label' => self::get_jmonth_name_by_number($i), 'value' => $i];
    }
    return $months;
  }
  ...
  public static function get_jweekday_name_by_number($weekday_number, $short = false){
    $weekday_names = [__('Saturday', 'latepoint'),
                      __('Sunday', 'latepoint'),
                      __('Monday', 'latepoint'),
                      __('Tuesday', 'latepoint'),
                      __('Wednesday', 'latepoint'),
