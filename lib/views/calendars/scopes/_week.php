				    ...
				    for($day_date=clone $calendar_start; $day_date<=$calendar_end; $day_date->modify('+1 day')) {
				      ...
				      ?>
							<div class="ch-day-periods-i <?php echo esc_attr($day_off_class); ?>">
								<div class="ch-day ch-day-<?php echo esc_attr(strtolower($day_date->jformat('N'))); ?> <?php if($today_date == $day_date) echo 'is-today'; ?>">
									<span><?php echo esc_html(OsUtilHelper::get_jweekday_name_by_number($day_date->jformat('N'), true)); ?></span>
									<strong><?php echo esc_html($day_date->jformat('j')); ?></strong>
								...
								<div class="ch-day-periods ch-day-<?php echo esc_attr(strtolower($day_date->jformat('N')));?> <?php echo esc_attr($day_off_class); ?>">
                                    <?php
