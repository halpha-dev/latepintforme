...
if ( $target_date->format('Y')<1600)
{
	$oo = JalaliCalendar::toGregorianDate($target_date->format('Y'),$target_date->format('m'),$target_date->format('d'));
	$target_date_string = $oo->format('Y-m-d');
			...
			<div class="os-calendar-settings-main">
				<div class="os-current-month-label-w calendar-mobile-controls">
					<div class="os-current-month-label">
						...
						<div class="current-year"><?php echo esc_html($target_date->jformat('Y')); ?></div>
					</div>
                    <div class="cc-panel">
					<div class="cc-actions">
						...
						<div class="cc-navigate-arrows">
							<a href="#" class="cc-action-prev os-calendar-prev-btn"><i class="latepoint-icon latepoint-icon-arrow-right"></i></a>
							<a href="#" class="cc-action-next os-calendar-next-btn"><i class="latepoint-icon latepoint-icon-arrow-left"></i></a>
						</div>
					</div>
					<div class="cc-view">
						<?php
