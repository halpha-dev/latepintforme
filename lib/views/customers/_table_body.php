...
if($customers){
  foreach ($customers as $customer):
    ...
    <tr class="os-clickable-row" <?php echo OsCustomerHelper::quick_customer_btn_html($customer->id); ?>>
      ...
      <td><?php echo ($next_booking) ? esc_html($next_booking->nice_start_jdatetime) : esc_html__('n/a', 'latepoint'); ?></td>
      ...
      <td><?php echo esc_html($customer->jformatted_created_date()); ?></td>
    </tr>
    <?php 
  endforeach;
}?>