		...
		<div class="full-screen-year-calendar">
			...
			<div class="full-screen-year-calendar-months">
				...
				<?php for ($i = 1; $i <= 12; $i++) {
					...
					echo '<div class="os-monthly-calendar-days-w" data-calendar-year="' . esc_attr($target_date->jformat('Y')) . '" data-calendar-month="' . esc_attr($target_date->jformat('n')) . '" data-calendar-month-label="' . esc_attr(OsUtilHelper::get_jmonth_name_by_number($target_date->jformat('n'))) . '">
