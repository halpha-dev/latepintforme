...
<div class="pro-feature-banner">
	...
	<a href="#" class="latepoint-pro-link" <?php echo OsSettingsHelper::get_link_attributes_for_premium_features(); ?>><?php esc_html_e('Show All premium features', 'latepoint'); ?></a>
</div>