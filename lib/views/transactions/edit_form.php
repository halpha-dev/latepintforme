    ...
    <div class="quick-add-transaction-box">
        ...
        <div class="quick-add-transaction-box-content">
            ...
            <div class="os-row">
                ...
                <div class="os-col-lg-6">
					<?php echo OsFormHelper::text_field( 'transactions[' . $real_or_rand_id . '][created_at]', __( 'Date', 'latepoint' ), $transaction->jformatted_created_date( 'Y-m-d', OsTimeHelper::today_date() ), [
