...
<div class="os-wizard-desc"><?php esc_html_e('You can now insert a booking button on any page using <span class="shortcode-example">[latepoint_book_button]</span> shortcode or by adding a WordPress block called Booking Button.', 'latepoint'); ?></div>
